...
Working datestamp: **June 24, 2015** (2015-06-24), inferred from the latest explicit dates in source/resources.json. Both “Bulk of Oregon now under drought conditions” and “Conceptualizing the Risk and Uncertainty of Climate Change with Valentina Bosetti” have `created: 2015 06 24`. These are reference-entry dates, not verified publication dates of the essay or article. Stanford's contemporary announcement and Bosetti's CV identify the talk as June 23, 2015:
https://casbs.stanford.edu/news/valentina-bosetti-interval-lifes-great-balancing-act

The article's original Bend Bulletin URL could not be retrieved. Its publication date has not been independently verified. This date is therefore an editorial inference, not proof that all passages were completed or published that day. Later meetup dates are scheduled events, not citations establishing composition. The date's basis is disclosed in a small footer note; no datePublished metadata claims independent certainty.

Domain registration: April 20, 2015, 18:33:09.047 UTC, according to the registry RDAP record:
https://rdap.identitydigital.services/rdap/domain/simulate.world
